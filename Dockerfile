...
#tempに実行ファイル追加
COPY assets/202307090739-Hermes2D_2-vs-R3CESBU_6.rcg /home/${USER_NAME}/202307090739-Hermes2D_2-vs-R3CESBU_6.rcg
COPY assets/entry_point.sh /tmp/entry_point.sh
COPY assets/program /home/${USER_NAME}/rcss/program
RUN sudo chmod +x /tmp/entry_point.sh ;\
    sudo chmod -R 777 /home/${USER_NAME}/rcss ;\
    echo 'export LD_LIBRARY_PATH="/usr/local/lib:$LD_LIBRARY_PATH"' >> /home/${USER_NAME}/.bashrc
